...
object NavigationEndpointSerializer :
    ...
    override fun selectDeserializer(element: JsonElement): DeserializationStrategy<NavigationEndpoint> =
        when {
            ...
            "queueAddEndpoint" in element.jsonObject -> NavigationEndpoint.QueueAddNavigationEndpoint.serializer()

            "searchEndpoint" in element.jsonObject -> NavigationEndpoint.SearchNavigationEndpoint.serializer()
